    ...
    ">
      ...
      <div className="flex flex-col gap-6 w-full max-w-lg text-neutral-200 p-4 rounded-lg bg-gray-800">
        <div className="flex justify-between gap-4">
          ...
          <img className="w-1/4" src="./assets/image/help-1.jpg" alt="help image 1" />
        </div>
        <div className="flex justify-between gap-4">
          <h2 className="flex gap-2 text-neutral-200 text-lg font-bold">
            <span>2.</span>8方向の好きな方向へ直線でドラッグ
          </h2>
          <img className="w-1/4" src="./assets/image/help-2.jpg" alt="help image 2" />
        </div>
        <div className="flex justify-between gap-4">
          <h2 className="flex gap-2 text-neutral-200 text-lg font-bold">
            <span>3.</span>同じ数字又は合計10になるように繋げる
          </h2>
          <img className="w-1/4" src="./assets/image/help-3.jpg" alt="help image 3" />
        </div>
        <div className="flex justify-between gap-4">
          <h2 className="flex gap-2 text-neutral-200 text-lg font-bold">
            <span>4.</span>クリックを離す
          </h2>
          <img className="w-1/4" src="./assets/image/help-4.jpg" alt="help image 4" />
        </div>
      </div>
